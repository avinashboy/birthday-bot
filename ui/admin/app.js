...
function logoutBtn() {
  return tempToken = undefined, $(".mainPage,.logOutBtn, .listPage,#nameServer").remove(), $("body").append(`<h1 class="text-center">Successfull logout</h1>`)
}
...
function deleteRow(idDelete) {
  ...
  $('#tableBook').on('click', '.deleteMe', function (e) {
    ...
    setTimeout(() => { miniTable(tempData) }, 1000)
  })
  return
}
